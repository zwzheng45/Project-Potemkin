...
from aip_agent.executor.temporal import get_temporal_client
from aip_agent.telemetry.tracing import setup_tracing

app = FastMCP("aip-agent-server")

setup_tracing("aip-agent-server")
