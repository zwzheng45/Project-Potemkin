...
from aip_agent.logging.events import Event, EventFilter, EventType
...
class LoggingListener(FilteredListener):
    ...
    def __init__(
        ...
        Initialize the listener.
        Args:
            logger: Logger to use for event processing. Defaults to 'aip_agent'.
        """
        super().__init__(event_filter=event_filter)
        self.logger = logger or logging.getLogger("aip_agent")
