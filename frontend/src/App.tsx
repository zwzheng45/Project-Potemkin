...
const translations = {
  en: {
    ...
    familyIdAutoHint: 'Family ID will be randomly generated and unique once creation finishes.',
    stakeUsageHint:
  ...
  familyIdAutoHint: '家庭 ID 会在创建完成后随机生成且唯一。',
  ...
  familyIdAutoHint: "L'ID familial sera généré automatiquement, de façon aléatoire et unique, après la création.",
  ...
  familyIdAutoHint: 'Die Familien-ID wird nach der Erstellung zufällig und eindeutig vergeben.',
  ...
  familyIdAutoHint: '家族 ID は作成完了後にランダムな一意の値が付与されます。',
